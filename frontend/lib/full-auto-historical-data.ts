...
const expansionReplayPack = [
  ...
  source(
    ...
    "Replay mark: present-day placeholder snapshot for the walk-forward demo; live market data is not claimed.",
...
const coreReplaySources: HistoricalSource[] = [
  ...
  source("MSFT", "price", "Present replay mark", "2026-04-17T20:00:00.000Z", "Replay mark: present-day placeholder snapshot for the walk-forward demo; live market data is not claimed.", { metrics: { price: 500.0 }, price: 500.0 }),
  source(
    "NVDA",
    "filing",
  ...
  source("NVDA", "price", "Present replay mark", "2026-04-17T20:00:00.000Z", "Replay mark: present-day placeholder snapshot for the walk-forward demo; live market data is not claimed.", { metrics: { price: 155.0 }, price: 155.0 }),
  source(
    "TSLA",
    "news",
  ...
  source("TSLA", "price", "Present replay mark", "2026-04-17T20:00:00.000Z", "Replay mark: present-day placeholder snapshot for the walk-forward demo; live market data is not claimed.", { metrics: { price: 300.0 }, price: 300.0 }),
  source(
    "AMD",
    "filing",
  ...
  source("AMD", "price", "Present replay mark", "2026-04-17T20:00:00.000Z", "Replay mark: present-day placeholder snapshot for the walk-forward demo; live market data is not claimed.", { metrics: { price: 175.0 }, price: 175.0 }),
  source(
    "NFLX",
    "news",
  ...
  source("NFLX", "price", "Present replay mark", "2026-04-17T20:00:00.000Z", "Replay mark: present-day placeholder snapshot for the walk-forward demo; live market data is not claimed.", { metrics: { price: 720.0 }, price: 720.0 }),
  source(
    "META",
    "news",
  ...
  source("META", "price", "Present replay mark", "2026-04-17T20:00:00.000Z", "Replay mark: present-day placeholder snapshot for the walk-forward demo; live market data is not claimed.", { metrics: { price: 625.0 }, price: 625.0 }),
  source(
    "SPY",
    "macro",
  ...
  source("SPY", "macro", "Present replay regime", "2026-04-17T20:00:00.000Z", "Replay mark: present-day macro placeholder for the walk-forward demo; live market data is not claimed.", { metrics: { price: 570.0, vix: 17.0 }, price: 570.0 }),
];
